...
class Rateodp extends CActiveRecord
{
	...
	public function odpByUser($rateid,$userid)
	{
		$criteria = new CDbCriteria;
		$criteria->select = " LPAD(t.supplierid,8,0) as supplierid, LPAD(t.rateodpid,8,0) as rateodpid, LPAD(t.rateid,8,0) as rateid, r.version, sp.corporatename, sp.rfc, sp.address, sp.suburb, ct.citydsc, sp.phone, st.statedsc, ".
