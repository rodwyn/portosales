...
class Ratezerotest extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'rateid' => 'Rateid',
			'courierdeliverydate' => 'Fecha de entrega mensajería',
			'customerdeliverydate' => 'Fecha de entrega cliente',
			'receivercustomer' => 'Quién recibe cliente',
			'deliverytestnumber' => 'Cantidad de pruebas entregadas',
			'authorization' => 'Autorizó',
			'rejectreason' => 'Motivo de rechazo',
			'zerotestauthorization' => 'Prueba cero autorizada por',
			'authorizationtest' => 'Fecha de autorización',
			'scheduleddelivery' => 'Entrega Programada',
			'realdelivery' => 'Entrega Real',
			'active' => 'Active',
