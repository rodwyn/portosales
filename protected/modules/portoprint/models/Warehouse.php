...
class Warehouse extends CActiveRecord
{
        ...
        public function getAllwarehouse()
	{
		$criteria=new CDbCriteria;
                ...
                $criteria->select="t.warehouseid, c.customerdsc, t.name, t.adress, t.neighborhood, t.schedule, t.contact, t.phone, t.email";
		...
		return $this->findAll($criteria);
         ...
         public function getIdwarehouse($customerid){
		...
		return $this->findAll($criteria);
          ...
          public function validar_campo($lista){
            ...
            foreach ($lista as $valor => $descripcion){
                        if($cadena==" " && $valor!="adress" && $valor!="neighborhood" && $valor!="schedule" && $valor!="phone"&& $valor!="email"){
                            $cadena=" t.".$valor." = '".$descripcion."'";
                        }else if($valor!="adress" && $valor!="neighborhood" && $valor!="schedule" && $valor!="phone"&& $valor!="email"){
