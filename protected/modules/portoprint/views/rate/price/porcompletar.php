					...
					<div class="widget-body">
							...
							<div>
								<div class="alert in alert-block fade alert-danger">		            
						            ...
						            <td><a href="#index.php?r=portoprint/rate/created2/id/<?php echo Utils::encrypt($model->rateid,'rate'); ?>/add/<?php echo Utils::encrypt($add,'rate'); ?>/edt/<?php echo Utils::encrypt($edt,'rate'); ?>/del/<?php echo Utils::encrypt($del,'rate'); ?>/menu/<?php echo Utils::encrypt($menu,'rate'); ?>" class="btn btn-danger btn-lg">Completar</a></td></tr>
						            </table>
						         </div>
							</div>	
