<form method="post" action="?r=portoprint/rate/savecolor/id/<?php echo Utils::encrypt($rateid, 'rate'); ?>" id="<?php echo 'ratecolor-'.$rateid.'-form'; ?>" novalidate="novalidate" class="smart-form">
		<header>
			...
			<div class="row">
				<section class="col col-6">
					...
					<div class="inline-group">
						<label class="radio">
							<input type="radio" name="Ratecolortest[authorizationtest]" value="1" <?php echo ($model->authorizationtest)?"checked='checked'":""; ?> id="Ratecolortest_authorizationtest_0_<?php echo $rateid; ?>">
							<i></i>Si
						</label>
						<label class="radio">
							<input type="radio" name="Ratecolortest[authorizationtest]" value="0" <?php echo ($model->authorizationtest)?"":"checked='checked'"; ?> id="Ratecolortest_authorizationtest_1_<?php echo $rateid; ?>">
							<i></i>No
						</label>
					</div>					
				</section>
