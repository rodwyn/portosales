<form method="post" action="?r=portoprint/rate/savezero/id/<?php echo Utils::encrypt($model->rateid, 'rate'); ?>" id="<?php echo 'ratezero-'.$model->rateid.'-form'; ?>" novalidate="novalidate" class="smart-form">
		<header>
		...
		<fieldset>
			<div class="row">
				<section class="col col-6">
					...
					<label class="input">
						<input type="text" class="date input-xs" value="<?php echo $model->courierdeliverydate; ?>" id="Ratezerotest_courierdeliverydate_<?php echo $model->rateid; ?>" name="Ratezerotest[courierdeliverydate]">
					</label>					
				</section>
				<section class="col col-6">
					<label class="label">Fecha de entrega cliente</label>
					<label class="input">
						<input type="text" class="date input-xs" value="<?php echo $model->customerdeliverydate; ?>" id="Ratezerotest_customerdeliverydate_<?php echo $model->rateid; ?>" name="Ratezerotest[customerdeliverydate]">
					</label>					
				</section>
			</div>
			<div class="row">
			...
			<div class="row">
				<section class="col col-6">
					...
					<div class="inline-group">
						<label class="radio">
							<input type="radio" class="input-xs" <?php echo ($model->authorization)?"checked='checked'":""; ?> name="Ratezerotest[authorization]" value="1" id="Ratezerotest_authorization_0_<?php echo $model->rateid; ?>">
							<i></i>Si
						</label>	
						<label class="radio">
							<input type="radio"  class="input-xs" <?php echo ($model->authorization)?"":"checked='checked'"; ?> name="Ratezerotest[authorization]" value="0" id="Ratezerotest_authorization_1_<?php echo $model->rateid; ?>">
							<i></i>No
						</label>
					</div>					
				</section>
