<form method="post" action="?r=portoprint/rate/saveart/id/<?php echo Utils::encrypt($rateid, 'rate'); ?>" id="<?php echo 'rateart-'.$rateid.'-form'; ?>" novalidate="novalidate" class="smart-form">
		<header>
				<strong>Arte</strong>
		</header>
		<fieldset>
			<div class="row">
				<section class="col col-6">
					...
					<label class="input">
						<input type="text" value="<?php echo $model->receptiondate; ?>" class="date input-xs" id="Rateart_receptiondate_<?php echo $rateid; ?>" name="Rateart[receptiondate]">
					</label>					
				</section>
				<section class="col col-6">
					<div class="inline-group">
						<label class="checkbox">
							<input type="checkbox" <?php echo ($model->filerevision1)?"checked='checked'":""; ?> value="1" id="Rateart_filerevision1_<?php echo $rateid; ?>" name="Rateart[filerevision1]">
							<i></i>Overprint</label>
						<label class="checkbox">
							<input type="checkbox" <?php echo ($model->filerevision2)?"checked='checked'":""; ?> value="1" id="Rateart_filerevision2_<?php echo $rateid; ?>" name="Rateart[filerevision2]">
							<i></i>Fuentes</label>
						<label class="checkbox">
							<input type="checkbox" <?php echo ($model->filerevision3)?"checked='checked'":""; ?> value="1" id="Rateart_filerevision3_<?php echo $rateid; ?>" name="Rateart[filerevision3]">
							<i></i>Imagenes CMYK</label>
						<label class="checkbox">
							<input type="checkbox" <?php echo ($model->filerevision4)?"checked='checked'":""; ?> value="1" id="Rateart_filerevision4_<?php echo $rateid; ?>" name="Rateart[filerevision4]">
			...
			<div class="row">
				<section class="col col-12">
					...
					<div class="inline-group">
						<label class="radio">
							<input type="radio" name="Rateart[changes]" value="1" <?php echo ($model->changes)?"checked='checked'":""; ?> id="Rateart_changes_0_<?php echo $rateid; ?>">
							<i></i>Si
						</label>
						<label class="radio">
							<input type="radio" name="Rateart[changes]" value="0" <?php echo ($model->changes)?"":"checked='checked'"; ?> id="Rateart_changes_1_<?php echo $rateid; ?>">
							<i></i>No
						</label>
					</div>
			...
			<div class="row">
				...
				<section class="col col-6">
					...
					<label class="input">
						<input type="text" value="<?php echo $model->senddate;?>" id="Rateart_senddate_<?php echo $rateid; ?>" name="Rateart[senddate]" class="date input-xs">
					</label>
				</section>
			</div>
			<div class="row">
				<section class="col col-6">
					...
					<label class="input">
						<input type="text" value="<?php echo $model->authorizationdate; ?>" id="Rateart_authorizationdate_<?php echo $rateid; ?>" name="Rateart[authorizationdate]"  class="date input-xs">
					</label>
				</section>
				<section class="col col-6">
