						...
						<div class="widget-body-toolbar">
							...
							<div class="row">								
								<section class="col col-3">
									...
									<a href="javascript:void(0);" id="btnag" class="btn btn-success" data-target="#newproject"  data-toggle="modal">Nueva Entidad</a>
                                                                    </div>
							     </section>
							...
							<tbody>
                                                           <?php foreach($model as $valor){ ?>
                                                               ...
                                                               <tr >
                                                                   ...
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_legalentity_dsc" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>" ondblclick="jq_edit_t(this.id)" ><?php echo $valor->legalentity ?> </td>
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_rfc_rfc" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>"  ondblclick="jq_edit_t(this.id)" ><?php echo $valor->rfc; ?></td>
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_street_dsc" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>"  ondblclick="jq_edit_t(this.id)" ><?php echo $valor->street; ?></td>
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_number_enu" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>"  ondblclick="jq_edit_t(this.id)" ><?php echo $valor->number; ?></td>
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_neighborhood_dsc" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>"  ondblclick="jq_edit_t(this.id)" ><?php echo $valor->neighborhood; ?></td>
                                                                   <td id="<?php echo $valor->customerlegalentityid ?>_zipcode_cp" data-url="<?php echo Yii::app()->createAbsoluteUrl('portoprint/customerlegalentity/updatelegalentity') ?>"  ondblclick="jq_edit_t(this.id)" ><?php echo $valor->zipcode; ?></td>
      ...
      <div class="modal-body no-padding">
        ...
        <fieldset>
			...
			<tbody>
					...
					<tr>
					<td ><label for="NTproject">Entidad Legal</label></td><td  id="NT_legalentitytd">
					<input type="text" id="NT_legalentity_dsc" />
					</td>
                                        </tr>
                                        <tr>
					<td ><label for="NTproject">RFC </label></td><td id="NT_rfctd">
					...
					<!--<input type="text" id="NTcliente" />-->
                                            <select id="customer_legal" name="customer_legal" class="select2" >
					...
					<!--<input type="text" id="NTcliente" />-->
                                        <select id="country_customerlegal" name="country_customerlegal" class="select2" data-live-search="true">
					...
					<!--<input type="text" id="NTcliente" />-->
                                        <select id="state_customerlegal" name="state_customerlegal" class="select2">
					...
					<!--<input type="text" id="NTcliente" />-->
                                            <select id="city_customerlegal" name="city_customerlegalentityid" class="select2" >
