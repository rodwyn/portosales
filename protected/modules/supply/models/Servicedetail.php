...
class Servicedetail extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'rateservicedetails' => array(self::HAS_MANY, 'Rateservicedetail', 'servicedetailid'),
	...
	public function getDetailByServiceid($serviceid){
		
		$criteria = new CDbCriteria;
		$criteria->select = " * ";
		$criteria->join = "INNER JOIN  itemdetail id ON id.itemdetailid = t.itemdetailid";
		$criteria->condition = " t.serviceid = {$serviceid} and t.active = 1";
		$criteria->order = " id.order asc ";
