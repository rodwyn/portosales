					...
					<div class="widget-body">
							...
							<div>
								<div class="alert in alert-block fade alert-info">	
									<form method="post" action="?r=portoprint/rate/selsuppliers/id/<? echo Utils::encrypt($model->rateid, 'rate'); ?>" id="<? echo 'ratesupplier-'.$model->rateid.'-form'; ?>" novalidate="novalidate" class="smart-form">            
