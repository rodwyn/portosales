...
class Usercontactpermission extends CActiveRecord
{
	...
	public function search()
	{
        ...
        public function getidSupplier($id,$active)
	{
		$criteria=new CDbCriteria;
		
		$criteria->select="t.supplierdsc, su.firstname, su.plastname";
                $criteria->join="inner join supplieruser su on su.supplierid=t.supplierid
                                inner join user u on u.userid= su.userid";
                $criteria->condition = "u.usertype=2 and u.userid={$id}";
