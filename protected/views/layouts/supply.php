		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					...
					<li id="ml1" class="">
						<a href="<?php echo Yii::app()->createUrl('/supply/rate/index'); ?>" title="Cotizaciones"><i class="fa fa-lg fa-fw fa-tasks"></i> <span class="menu-item-parent">Cotizaciones</span></a>
					</li>
