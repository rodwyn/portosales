...
<html lang="en-us">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/select2-bootstrap.css">
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/dataTables.responsive.css" type="text/css"/>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/vis.css" type="text/css"/>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/themes/default/style.css" type="text/css"/>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/plugin/select2/select2.js"></script>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/plugin/fullcalendar/jquery.fullcalendar.min.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/raphael.2.1.0.min.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/justgage.1.0.1.min.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/vis.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/jstree.min.js"></script>

        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/jquery.circliful.min.js"></script>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/jquery.circliful.css" type="text/css"/>
        
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/bootstrap-switch.js"></script>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/bootstrap-switch.css" type="text/css"/>
        <!-- js y css range -->
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/theme/js/rangeslider.js"></script>
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/theme/css/rangeslider.css" type="text/css"/>
    ...
    <body class="">
        ...
        <header id="header">
            ...
            <div id="project-context">
                ...
                <span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown"><?php echo Yii::app()->user->companydsc; ?> <i class="fa fa-angle-down"></i></span>

                <!-- Suggestion: populate this list with fetch and push technique -->
                <ul class="dropdown-menu">
                    <?php foreach (Yii::app()->user->companies as $company => $row) { ?>
                        <li>
                            <a href="<?php echo Yii::app()->createUrl('/portoprint/change/company', array('id' => $company)); ?>"><?php echo $row['companydsc']; ?></a>
                        </li>
                    <?php } ?>
        ...
        <script type="text/javascript">
            $(".limenu").click(function(){
                ...
                $.post('<?php echo Yii::app()->createAbsoluteUrl('portoprint/activity/addactivity') ?>', {'menuid': menuid, 'activity': activity}, function(response) {
